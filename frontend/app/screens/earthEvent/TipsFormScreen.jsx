...
import { View, Text, SafeAreaView, ScrollView, TouchableOpacity, TextInput, Dimensions, Platform, ActivityIndicator,  Image, Alert, } from 'react-native';
...
const uploadImagesToFirebase = async (images) => {
    ...
    try {
        for (let image of images) {
            ...
            const imageRef = storageRef.child(`Tips/${uniqueFileName}`);
